...
## What was done in this branch (your team)
...
4. Fairness tooling for team comparison

- Added fair side-by-side harness:
    - src/part_a/fair_compare_part_a.py
- This runs both team workstreams under identical policy:
    - same N
    - same warmup
    - same repeats
    - same timing metric
...
## Team workstream separation

Parallel teammate code is isolated and preserved as snapshot only:
...
- Treat these files as read-only snapshot.
