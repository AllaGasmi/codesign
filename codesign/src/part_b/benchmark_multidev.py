"""Part B: robust multi-device run with split tuning.

NVIDIA executes matmul_naive (uncoalesced) and Intel executes matmul_best.
Rows are split between devices and tuned around a theoretical ratio.
"""
